...
Misc.IKfile = {fullfile(DataPath,'ik_TA1_0.mot'); fullfile(DataPath,'ik_TA1_10.mot'); fullfile(DataPath,'ik_TA1_20.mot'); fullfile(DataPath,'ik_TA1_-5.mot')};
Misc.IDfile = {fullfile(DataPath,'inverse_dynamics_TA1_0.sto'); fullfile(DataPath,'inverse_dynamics_TA1_10.sto'); fullfile(DataPath,'inverse_dynamics_TA1_20.sto'); fullfile(DataPath,'inverse_dynamics_TA1_-5.sto')};
Misc.EMGfile = {fullfile(DataPath,'emg_TA1_0.mot'); fullfile(DataPath,'emg_TA1_10.mot'); fullfile(DataPath,'emg_TA1_20.mot'); fullfile(DataPath,'emg_TA1_-5.mot')};
Misc.USfile = {fullfile(DataPath,'US_TA1_0.mot'); fullfile(DataPath,'US_TA1_10.mot'); fullfile(DataPath,'US_TA1_20.mot'); fullfile(DataPath,'US_TA1_-5.mot')}; % in mm


%-------------
model_path   = {fullfile(pwd, strcat('S', subject, '.osim'))};
