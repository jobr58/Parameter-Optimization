...
Misc.IKfile = {     fullfile(DataPath,'ik_TA_0.mot'); ...
                    fullfile(DataPath,'ik_TA_5.mot'); ...
                    fullfile(DataPath,'ik_TA_10.mot'); ...
                    fullfile(DataPath,'ik_TA_20.mot')};
            
Misc.IDfile = {     fullfile(DataPath,'inverse_dynamics_TA_0.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_TA_5.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_TA_10.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_TA_20.sto')};
            
Misc.EMGfile = {    fullfile(DataPath,'emg_TA_0.mot'); ...
                    fullfile(DataPath,'emg_TA_5.mot'); ...
                    fullfile(DataPath,'emg_TA_10.mot'); ...
                    fullfile(DataPath,'emg_TA_20.mot')};
                
Misc.USfile = {     fullfile(DataPath,'US_TA_0.mot'); ...
                    fullfile(DataPath,'US_TA_5.mot'); ...
                    fullfile(DataPath,'US_TA_10.mot'); ...
                    fullfile(DataPath,'US_TA_20.mot')}; % in mm


%-------------
model_path   = {fullfile(pwd, 'SP3.osim')};
