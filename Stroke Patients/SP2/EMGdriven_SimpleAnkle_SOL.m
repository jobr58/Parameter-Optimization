...
Misc.IKfile = {     fullfile(DataPath,'ik_SOL_0.mot'); ...
                    fullfile(DataPath,'ik_SOL_10.mot'); ...
                    fullfile(DataPath,'ik_SOL_20.mot'); ...
                    fullfile(DataPath,'ik_SOL_-5.mot');...
                    fullfile(DataPath,'ik_SOL2_0.mot'); ...
                    fullfile(DataPath,'ik_SOL2_10.mot')};
            
Misc.IDfile = {     fullfile(DataPath,'inverse_dynamics_SOL_0.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_SOL_10.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_SOL_20.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_SOL_-5.sto');...
                    fullfile(DataPath,'inverse_dynamics_SOL2_0.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_SOL2_10.sto')};
            
Misc.EMGfile = {    fullfile(DataPath,'emg_SOL_0.mot'); ...
                    fullfile(DataPath,'emg_SOL_10.mot'); ...
                    fullfile(DataPath,'emg_SOL_20.mot'); ...
                    fullfile(DataPath,'emg_SOL_-5.mot');...
                    fullfile(DataPath,'emg_SOL2_0.mot'); ...
                    fullfile(DataPath,'emg_SOL2_10.mot')};
                
Misc.USfile = {     fullfile(DataPath,'US_SOL_0.mot'); ...
                    fullfile(DataPath,'US_SOL_10.mot'); ...
                    fullfile(DataPath,'US_SOL_20.mot'); ...
                    fullfile(DataPath,'US_SOL_-5.mot');...
                    fullfile(DataPath,'US_SOL2_0.mot'); ...
                    fullfile(DataPath,'US_SOL2_10.mot')}; % in mm


%-------------
model_path   = {fullfile(pwd, 'SP2.osim')};
...
Misc.wVm    = 0.01;
% Set weights
Misc.wlM    = [1; 1; 1; 1; 1; 1];          	% weight on tracking fiber length
...
for i = 1:6
    ...
    if i >= 5
        title(strcat('SOL2, ', muscles(i), 'degrees'))
        saveas(gca, fullfile(plot_path, strcat('SOL2_', muscles(i), 'deg')),'jpg');
    else
        title(strcat('SOL, ', muscles(i), 'degrees'))
        saveas(gca, fullfile(plot_path, strcat('SOL_', muscles(i), 'deg')),'jpg');
    end
end
