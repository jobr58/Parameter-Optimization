...
Misc.IKfile = {     fullfile(DataPath,'ik_TA2_0.mot'); ...
                    fullfile(DataPath,'ik_TA2_10.mot'); ...
                    fullfile(DataPath,'ik_TA2_20.mot'); ...
                    fullfile(DataPath,'ik_TA2_-5.mot')};
            
Misc.IDfile = {     fullfile(DataPath,'inverse_dynamics_TA2_0.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_TA2_10.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_TA2_20.sto'); ...
                    fullfile(DataPath,'inverse_dynamics_TA2_-5.sto')};
            
Misc.EMGfile = {    fullfile(DataPath,'emg_TA2_0.mot'); ...
                    fullfile(DataPath,'emg_TA2_10.mot'); ...
                    fullfile(DataPath,'emg_TA2_20.mot'); ...
                    fullfile(DataPath,'emg_TA2_-5.mot')};
                
Misc.USfile = {     fullfile(DataPath,'US_TA2_0.mot'); ...
                    fullfile(DataPath,'US_TA2_10.mot'); ...
                    fullfile(DataPath,'US_TA2_20.mot'); ...
                    fullfile(DataPath,'US_TA2_-5.mot')}; % in mm


%-------------
model_path   = {fullfile(pwd, 'SP2.osim')};
Out_path     = fullfile(pwd,'Results_SimpeAnkle_TA2'); % folder to store results
...
for i = 1:4
    ...
    title(strcat('TA2, ', muscles(i), 'degrees'))
    saveas(gca, fullfile(plot_path, strcat('TA2_', muscles(i), 'deg')),'jpg');
end
