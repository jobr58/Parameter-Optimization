...
Misc.IKfile = {fullfile(DataPath,'ik_GM_0.mot'); fullfile(DataPath,'ik_GM_10.mot'); fullfile(DataPath,'ik_GM_20.mot'); fullfile(DataPath,'ik_GM_-5.mot')};
Misc.IDfile = {fullfile(DataPath,'inverse_dynamics_GM_0.sto'); fullfile(DataPath,'inverse_dynamics_GM_10.sto'); fullfile(DataPath,'inverse_dynamics_GM_20.sto'); fullfile(DataPath,'inverse_dynamics_GM_-5.sto')};
Misc.EMGfile = {fullfile(DataPath,'emg_GM_0.mot'); fullfile(DataPath,'emg_GM_10.mot'); fullfile(DataPath,'emg_GM_20.mot'); fullfile(DataPath,'emg_GM_-5.mot')};
Misc.USfile = {fullfile(DataPath,'US_GM_0.mot'); fullfile(DataPath,'US_GM_10.mot'); fullfile(DataPath,'US_GM_20.mot'); fullfile(DataPath,'US_GM_-5.mot')}; % in mm
...
Misc.BoundsScaleEMG = [0.8 1.5];  % maximal value to scale EMG
...
[Results,DatStcore,Misc] = solveMuscleRedundancy(model_path,time,Out_path,Misc);
